...
export CATALOG_IMAGE=${CATALOG_IMAGE:-"quay.io/morana/ksd-container-security-operator-index:${TAG}"}
export OG_PATH=${OG_PATH:-'./bundle/cso.operatorgroup.yaml'}
export OPERATOR_PKG_NAME=${OPERATOR_PKG_NAME:-'ksd-container-security-operator'}
